...
import com.sunnycodes.exception.DuplicateResourceException;
import com.sunnycodes.exception.RequestValidationException;
import com.sunnycodes.exception.ResourceNotFoundException;
    ...
    public void uploadCustomerProfileImage(Integer customerId, MultipartFile file) {
        ...
        try {
            s3Service.putObject(
                    ...
                    "profile-images/%s/%s".formatted(customerId, UUID.randomUUID().toString()),
                    file.getBytes()
            );
        } catch (IOException e) {
        ...
        // TODO: Store profileImageId to database
